...
Nothing leaves your device. There is no server, no account, no upload, no
analytics. The camera feed is processed in the browser and discarded when you
close the tab. Stills and video save straight to your own downloads.
...
MIT. See [LICENSE](LICENSE). Images and video you make with it are entirely
yours.
